...
class $AssetsIconsGen {
  ...
  SvgGenImage get eyeHidden => const SvgGenImage('assets/icons/eye_hidden.svg');
  ...
  /// List of all assets
  List<SvgGenImage> get values => [eye, eyeHidden, lock, message];
}
...
class $AssetsImagesGen {
  ...
  /// List of all assets
  List<AssetGenImage> get values => [facebook, google, splashImage];
}
